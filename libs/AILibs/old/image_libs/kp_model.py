...
class KPModel(torch.nn.Module):
    def __init__(self, input_shape, n_features = 64):
        ...
        self.seg_head       = Outputhead(16 + 32 + 64, 128, 1)
        self.kp_head        = Outputhead(16 + 32 + 64, 128, 1)
        self.features_head  = Outputhead(16 + 32 + 64, 128, n_features)
...
if __name__ == "__main__":
    ...
    x = torch.randn((5, ) + input_shape)

    model = KPModel(input_shape)
    ...
    print(x.shape, seg.shape, kp.shape, z.shape)
