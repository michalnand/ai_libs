...
def nn_save_detector_prediction_distribution(result_path, y_gt, y_pred, threshold = 0.5):
...
def nn_save_detector_cm(result_path, metrics,):
...
def nn_save_detector_metrics(result_path, config, metrics):
    ...
    with open(md_file, "w", encoding="utf-8") as f:
        ...
        f.write(f"| `num_steps`  | {config.num_steps} |\n")
...
def nn_save_anomaly_detection_metrics(result_path, config, metrics):
