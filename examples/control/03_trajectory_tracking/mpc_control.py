...
if __name__ == "__main__":
    ...
    control_horizon    = 4
    controller = AILibs.MPCAnalytical(a_disc, b_disc, q, r, prediction_horizon, control_horizon, u_limit)
    ...
    # plot results
    AILibs.plot_cl_response(t_result, u_result, xr_result, x_result, "plots/mpc_result.png",  ["input X", "input Y"],  ["position X", "position Y", "velocity X", "velocity Y"])
    AILibs.plot_cl_response(t_result, u_result[:, [1]], xr_result[:, [1, 3]], x_result[:, [1, 3]], "plots/mpc_result_x.png",  [ "input X"],  [ "position X",  "velocity X"])
